...
use crate::drivers::attestation::Challenge;
use crate::qlib::common::Result;

use super::{AttEvidence, InitDataStatus};

pub trait AttesterT {
    fn get_tee_evidence(&self, challenge: &mut Challenge) -> Result<AttEvidence>;
...
//
// NOTE:Delete before commit -> add to att for cca
//
